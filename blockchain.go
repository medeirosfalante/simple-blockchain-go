...
//BlockchainIterator is a struct for iterator for blockchain
type BlockchainIterator struct {
	currentHash []byte
	db          *bolt.DB
}

//Iterator is a func interation in blockchain
func (bc *Blockchain) Iterator() *BlockchainIterator {
	bci := &BlockchainIterator{bc.tip, bc.db}
	return bci
}

// Next a interator block
...
//MineBlock is a func add a new block in blockchain
